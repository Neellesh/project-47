...
function setup() {
  ...
  heart1 = createSprite(150,70,20,20)
  heart1.visible = false
  heart1.addImage("heart1",heart1Img)
  heart1.scale = 0.4

  heart2 = createSprite(200,70,20,20)
  heart2.visible = false
  heart2.addImage("heart2",heart2Img)
  heart2.scale = 0.4

  heart3 = createSprite(200,70,20,20)
  ...
  queen.setCollider("rectangle",0,0,125,430);
  //queen.debug = true ;
...
function spawnObstacle (){
  ...
  if(frameCount%217 === 0){
    var obs = createSprite(width,random(100,height-100))
    obs.velocityX = -(10+4*score/400) ;
...
function gameOver() {
  swal({
    title: `Game Over`,
    text: "Seaqueen is caught by the Guardians..!!",
    imageUrl:
      "/assets/sword.png",
    imageSize: "125x125",
...
function gameWon(){
  swal({
    title: `Well Done Vera`,
    text: "Welcome to the Territory...!!!",
    imageUrl:
      "/assets/seaquen.png",
    imageSize: "150x150",
